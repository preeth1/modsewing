...
export const MEASUREMENTS = [
    ...
    {
        unfriendlyName: 'underBust',
        friendlyName: 'Under Bust',
        measurement: 29,
        image: bust, 
        helpText: 'XXXXXXXX'},
    {
        unfriendlyName: 'waist',
        friendlyName: 'Waist',
        measurement: 26,
        image: waist,
